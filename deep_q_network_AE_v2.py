...
"""v2:
change from AE v1: adv. image only on most recent image, not, and doesnt stay in memory;
analogy: you think you saw something late at night, it caused you to act some way, but it may have been you
imagining things since it didn't affect anything else in the world -- is the environment playing tricks on you?"""
